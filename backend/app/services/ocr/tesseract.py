    ...
    def extract_text(self, file_path: Path, document_type: str) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            if file_path.suffix.lower() == ".pdf":
                raise NotImplementedError("PDF not supported directly by local Tesseract fallback")
            ...
            logger.warning(f"Tesseract OCR failed or not configured: {e}. Simulating Tesseract fallback results.")
            return self._simulate_tesseract_extraction(document_type)

    def _parse_tesseract_text(self, text: str, document_type: str) -> Dict[str, Dict[str, Any]]:
        return self._simulate_tesseract_extraction(document_type)

    def _simulate_tesseract_extraction(self, document_type: str) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "address": {"value": "123 BAKER STREET, LONDON, W1A 1AA", "confidence": 0.72},
