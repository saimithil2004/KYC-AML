...
class AgentExecutionError(AgentBaseException):
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None, severity: str = "ERROR"):
        super().__init__(message, "AGENT_EXECUTION_ERROR", details, severity)

class AgentValidationError(AgentBaseException):
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None, severity: str = "WARNING"):
...
class NonRetryableError(AgentBaseException):
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None, severity: str = "CRITICAL"):
