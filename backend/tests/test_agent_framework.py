...
from app.agents.base.exceptions import (
    AgentExecutionError, AgentValidationError, DatabaseError,
    ConfigurationError, RiskCalculationError
)
...
def test_agent_context_injection():
    ...
    ctx = AgentContext(db_session=dummy_db, environment="staging", correlation_id="trace-999")
