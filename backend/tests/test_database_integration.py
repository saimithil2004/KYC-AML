...
def test_ingestion_validator():
    ...
    # Duplicate check
    is_v3, errs3 = IngestionValidator.validate_customer(
        valid_c, ["jack.roberts@externalbank.com"], []
    )
...
def test_data_quality_score():
    ...
    cust_incomplete = Customer(
        first_name="Jane", last_name="Doe", phone_number=None, street_address="123 Road"
    )
